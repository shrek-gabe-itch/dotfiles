...
// @version       2026/01/12 hide gpu memory
  ...
  init: function() {
    ...
    try {
      CustomizableUI.createWidget({
          ...
          label: 'Memory Usage',
          tooltiptext: 'Minimize Memory Usage',
          onClick(event) {
              event.target.documentGlobal.ucjsMemoryUsage.MRM.minimizeMemoryUsage(()=>{});
              event.target.documentGlobal.ucjsMemoryUsage.requestMemory()
          },
